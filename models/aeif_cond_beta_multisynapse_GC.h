/*
 *  aeif_cond_beta_multisynapse_GC.h
 *
 ...
 */
extern "C" int aeif_cond_beta_multisynapse_GC_dynamics( double, const double*, double*, void* );
...
Name: aeif_cond_beta_multisynapse_GC - Conductance based adaptive exponential
...
aeif_cond_beta_multisynapse_GC is a conductance-based adaptive exponential
...
Examples:
    ...
    neuron = nest.Create('aeif_cond_beta_multisynapse_GC')
...
SeeAlso: aeif_cond_alpha_multisynapse_GC
*/
class aeif_cond_beta_multisynapse_GC : public Archiving_Node
{

public:
  aeif_cond_beta_multisynapse_GC();
  aeif_cond_beta_multisynapse_GC( const aeif_cond_beta_multisynapse_GC& );
  virtual ~aeif_cond_beta_multisynapse_GC();

  friend int aeif_cond_beta_multisynapse_GC_dynamics( double, const double*, double*, void* );
...
private:
  ...
  friend class DynamicRecordablesMap< aeif_cond_beta_multisynapse_GC >;
  friend class DynamicUniversalDataLogger< aeif_cond_beta_multisynapse_GC >;
  friend class DataAccessFunctor< aeif_cond_beta_multisynapse_GC >;
  ...
  struct Parameters_
  {
    ...
    std::vector< double > G_ext;     //!< reversal potentials in mV
  ...
  struct Buffers_
  {
    Buffers_( aeif_cond_beta_multisynapse_GC& );
    Buffers_( const Buffers_&, aeif_cond_beta_multisynapse_GC& );

    //! Logger for all analog data
    DynamicUniversalDataLogger< aeif_cond_beta_multisynapse_GC > logger_;
  ...
  /**
   * @defgroup aeif_cond_beta_multisynapse_GC
  ...
  DataAccessFunctor< aeif_cond_beta_multisynapse_GC > get_data_access_functor( size_t elem );
  inline double
...
inline port
aeif_cond_beta_multisynapse_GC::send_test_event( Node& target, rport receptor_type, synindex, bool )
{
  SpikeEvent e;
  e.set_sender( *this );
...
inline port
aeif_cond_beta_multisynapse_GC::handles_test_event( CurrentEvent&, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
...
inline port
aeif_cond_beta_multisynapse_GC::handles_test_event( DataLoggingRequest& dlr, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
    throw UnknownReceptorType( receptor_type, get_name() );
...
inline void
aeif_cond_beta_multisynapse_GC::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
  S_.get( d );
