...
#ifndef aiaf_bw_2001_H
#define aiaf_bw_2001_H
 ...
 */
extern "C" inline int aiaf_bw_2001_dynamics( double, const double*, double*, void* );
...
``aiaf_bw_2001`` is a leaky integrate-and-fire neuron model with
...
.. note::
    For the NMDA dynamics to work,  both pre-synaptic and post-synaptic neurons must be of type ``aiaf_bw_2001``. For AMPA/GABA synapses, any pre-synaptic neuron can be used.

.. note::
    For technical reasons, spikes from ``aiaf_bw_2001`` neurons must be recorded with ``time_in_steps: True`` set in the spike recorder, ignoring the offset value. We hope to correct this in a future version of NEST.
...
.. listexamples:: aiaf_bw_2001

EndUserDocs */
// clang-format on

void register_aiaf_bw_2001( const std::string& name );

class aiaf_bw_2001 : public ArchivingNode
{
public:
  aiaf_bw_2001();
  aiaf_bw_2001( const aiaf_bw_2001& );
  ~aiaf_bw_2001() override;
...
private:
  ...
  friend int aiaf_bw_2001_dynamics( double, const double*, double*, void* );

  // The next two classes need to be friends to access the State_ class/member
  friend class RecordablesMap< aiaf_bw_2001 >;
  friend class UniversalDataLogger< aiaf_bw_2001 >;
...
private:
  ...
  struct Buffers_
  {
    Buffers_( aiaf_bw_2001& );
    Buffers_( const Buffers_&, aiaf_bw_2001& );

    //! Logger for all analog data
    UniversalDataLogger< aiaf_bw_2001 > logger_;
  ...
  static RecordablesMap< aiaf_bw_2001 > recordablesMap_;

}; /* neuron aiaf_bw_2001 */

inline size_t
aiaf_bw_2001::send_test_event( Node& target, size_t receptor_type, synindex, bool )
{
  SpikeEvent e;
  e.set_sender( *this );
...
inline size_t
aiaf_bw_2001::handles_test_event( SpikeEvent& e, size_t receptor_type )
{
...
inline size_t
aiaf_bw_2001::handles_test_event( CurrentEvent&, size_t receptor_type )
{
  if ( receptor_type != 0 )
  {
    throw UnknownReceptorType( receptor_type, get_name() );
...
inline size_t
aiaf_bw_2001::handles_test_event( DataLoggingRequest& dlr, size_t receptor_type )
{
  /*
...
inline void
aiaf_bw_2001::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
  S_.get( d );
...
inline void
aiaf_bw_2001::set_status( const DictionaryDatum& d )
{
