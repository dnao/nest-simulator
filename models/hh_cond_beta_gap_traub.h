...
/* BeginDocumentation
Name: hh_cond_beta_gap_traub - Hodgkin-Huxley neuron model with gap-junction support.
...
Description:
 ...
 at t = tau_xx_rise where xx is ex or in
...
private:
  ...
  struct Parameters_
  {
	...
	double V_T;        //!< Voltage offset for dynamics
