 ...
 * Recordables map
 * --------------------------------------------------------------------------- */
nest::RecordablesMap< nest::aiaf_bw_2001 > nest::aiaf_bw_2001::recordablesMap_;

namespace nest
{
void
register_aiaf_bw_2001( const std::string& name )
{
  register_node_model< aiaf_bw_2001 >( name );
}
/*
...
template <>
void
RecordablesMap< aiaf_bw_2001 >::create()
{
  // add state variables to recordables map
  insert_( names::V_m, &aiaf_bw_2001::get_ode_state_elem_< aiaf_bw_2001::State_::V_m > );
  insert_( names::s_AMPA, &aiaf_bw_2001::get_ode_state_elem_< aiaf_bw_2001::State_::s_AMPA > );
  insert_( names::s_GABA, &aiaf_bw_2001::get_ode_state_elem_< aiaf_bw_2001::State_::s_GABA > );
  insert_( names::s_K, &aiaf_bw_2001::get_ode_state_elem_< aiaf_bw_2001::State_::s_K > );
  insert_( names::s_NMDA, &aiaf_bw_2001::get_ode_state_elem_< aiaf_bw_2001::State_::s_NMDA > );
  insert_( names::I_NMDA, &aiaf_bw_2001::get_I_NMDA_ );
  insert_( names::I_AMPA, &aiaf_bw_2001::get_I_AMPA_ );
  insert_( names::I_GABA, &aiaf_bw_2001::get_I_GABA_ );
  insert_( names::I_K, &aiaf_bw_2001::get_I_K_ );
}
}

extern "C" inline int
nest::aiaf_bw_2001_dynamics( double, const double y[], double f[], void* pnode )
{
  // a shorthand
  typedef nest::aiaf_bw_2001::State_ S;

  // get access to node so we can almost work as in a member function
  assert( pnode );
  nest::aiaf_bw_2001& node = *( reinterpret_cast< nest::aiaf_bw_2001* >( pnode ) );
  ...
  node.S_.I_K_ = ( y[ S::V_m ] - node.P_.E_K ) * y[ S::s_K ];
...
nest::aiaf_bw_2001::Parameters_::Parameters_()
  : E_L( -70.0 )          // mV
  , E_ex( 0.0 )           // mV
  , E_in( -70.0 )         // mV
  , E_K( -85.0 )         // mV
...
nest::aiaf_bw_2001::State_::State_( const Parameters_& p )
  : r_( 0 )
{
...
nest::aiaf_bw_2001::State_::State_( const State_& s )
  : r_( s.r_ )
{
  y_[ V_m ] = s.y_[ V_m ];
...
nest::aiaf_bw_2001::Buffers_::Buffers_( aiaf_bw_2001& n )
  : logger_( n )
  , spikes_()
  , s_( nullptr )
  , c_( nullptr )
...
nest::aiaf_bw_2001::Buffers_::Buffers_( const Buffers_&, aiaf_bw_2001& n )
  : logger_( n )
  , s_( nullptr )
  , c_( nullptr )
  , e_( nullptr )
...
nest::aiaf_bw_2001::Parameters_::get( DictionaryDatum& d ) const
{
  ...
  def< double >( d, names::tau_K, tau_K );
...
void
nest::aiaf_bw_2001::Parameters_::set( const DictionaryDatum& d, Node* node )
{
  ...
  updateValueParam< double >( d, names::tau_K, tau_K, node );
...
nest::aiaf_bw_2001::State_::set( const DictionaryDatum& d, const Parameters_&, Node* node )
{
  ...
  updateValueParam< double >( d, names::s_K, y_[ s_K ], node );
}
...
nest::aiaf_bw_2001::aiaf_bw_2001()
  : ArchivingNode()
  , P_()
  , S_( P_ )
  , B_( *this )
...
nest::aiaf_bw_2001::aiaf_bw_2001( const aiaf_bw_2001& n_ )
  : ArchivingNode( n_ )
  , P_( n_.P_ )
  , S_( n_.S_ )
  , B_( n_.B_, *this )
...
nest::aiaf_bw_2001::init_buffers_()
{
  ...
  B_.sys_.function = aiaf_bw_2001_dynamics;
...
void
nest::aiaf_bw_2001::pre_run_hook()
{
...
void
nest::aiaf_bw_2001::update( Time const& origin, const long from, const long to )
{
  ...
  for ( long lag = from; lag < to; ++lag )
  {
    ...
    S_.y_[ State_::s_K ] += B_.spikes_[ SynapseTypes::K - 1 ].get_value( lag );
...
void
nest::aiaf_bw_2001::handle( DataLoggingRequest& e )
{
  B_.logger_.handle( e );
}

void
nest::aiaf_bw_2001::handle( SpikeEvent& e )
{
...
void
nest::aiaf_bw_2001::handle( CurrentEvent& e )
{
  assert( e.get_delay_steps() > 0 );
