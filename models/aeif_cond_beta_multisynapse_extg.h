/*
 *  aeif_cond_beta_multisynapse_extg.h
 *
...
#ifndef aeif_cond_beta_multisynapse_extg_H
#define aeif_cond_beta_multisynapse_extg_H
 ...
 */
extern "C" int aeif_cond_beta_multisynapse_extg_dynamics( double, const double*, double*, void* );
...
Name: aeif_cond_beta_multisynapse_extg - Conductance based adaptive exponential
...
aeif_cond_beta_multisynapse_extg is a conductance-based adaptive exponential
...
Constant external conductance is supplie by the array "g_ext".
...
g_ext    list of nS    External conductances
...
Examples:
    ...
    neuron = nest.Create('aeif_cond_beta_multisynapse_extg')
    nest.SetStatus(neuron, {"V_peak": 0.0, "a": 4.0, "b":80.5})
    nest.SetStatus(neuron, {'E_rev':[0.0,0.0,0.0,-85.0],
                            'g_ext':[0.0,0.0,0.0,0.0],
...
*/
class aeif_cond_beta_multisynapse_extg : public Archiving_Node
{

public:
  aeif_cond_beta_multisynapse_extg();
  aeif_cond_beta_multisynapse_extg( const aeif_cond_beta_multisynapse_extg& );
  virtual ~aeif_cond_beta_multisynapse_extg();

  friend int aeif_cond_beta_multisynapse_extg_dynamics( double, const double*, double*, void* );
...
private:
  ...
  friend class DynamicRecordablesMap< aeif_cond_beta_multisynapse_extg >;
  friend class DynamicUniversalDataLogger< aeif_cond_beta_multisynapse_extg >;
  friend class DataAccessFunctor< aeif_cond_beta_multisynapse_extg >;
  ...
  struct Parameters_
  {
    ...
    std::vector< double > g_ext;     //!< external condutances in nS
  ...
  struct Buffers_
  {
    Buffers_( aeif_cond_beta_multisynapse_extg& );
    Buffers_( const Buffers_&, aeif_cond_beta_multisynapse_extg& );

    //! Logger for all analog data
    DynamicUniversalDataLogger< aeif_cond_beta_multisynapse_extg > logger_;
  ...
  /**
   * @defgroup aeif_cond_beta_multisynapse_extg
  ...
  DynamicRecordablesMap< aeif_cond_beta_multisynapse_extg > recordablesMap_;

  // Data Access Functor getter
  DataAccessFunctor< aeif_cond_beta_multisynapse_extg > get_data_access_functor( size_t elem );
  inline double
...
inline port
aeif_cond_beta_multisynapse_extg::send_test_event( Node& target, rport receptor_type, synindex, bool )
{
  SpikeEvent e;
  e.set_sender( *this );
...
inline port
aeif_cond_beta_multisynapse_extg::handles_test_event( CurrentEvent&, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
...
inline port
aeif_cond_beta_multisynapse_extg::handles_test_event( DataLoggingRequest& dlr, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
    throw UnknownReceptorType( receptor_type, get_name() );
...
inline void
aeif_cond_beta_multisynapse_extg::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
  S_.get( d );
...
#endif // HAVE_GSL
#endif // aeif_cond_beta_multisynapse_extg_H //
