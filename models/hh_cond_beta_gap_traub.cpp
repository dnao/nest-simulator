...
RecordablesMap< hh_cond_beta_gap_traub >::create()
{
  ...
  insert_( names::V_m,
    &hh_cond_beta_gap_traub::get_y_elem_<
      hh_cond_beta_gap_traub::State_::V_M > );
  insert_( names::g_ex,
    &hh_cond_beta_gap_traub::get_y_elem_<
      hh_cond_beta_gap_traub::State_::G_EXC > );
  insert_( names::g_in,
    &hh_cond_beta_gap_traub::get_y_elem_<
      hh_cond_beta_gap_traub::State_::G_INH > );
  insert_( names::Act_m,
    &hh_cond_beta_gap_traub::get_y_elem_<
      hh_cond_beta_gap_traub::State_::HH_M > );
  insert_( names::Act_h,
    &hh_cond_beta_gap_traub::get_y_elem_<
      hh_cond_beta_gap_traub::State_::HH_H > );
  insert_( names::Inact_n,
    &hh_cond_beta_gap_traub::get_y_elem_<
      hh_cond_beta_gap_traub::State_::HH_N > );
}
...
nest::hh_cond_beta_gap_traub::Parameters_::Parameters_()
  ...
  , V_T( -63.0 )         // adjusts threshold to around -50 mV      (mV)
...
nest::hh_cond_beta_gap_traub::State_& nest::hh_cond_beta_gap_traub::
